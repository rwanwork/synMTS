...
"Usage:  deepmito-violin.R --input INPUT --output OUTPUT --type IMGTYPE
...
######################################################################
##  Aggregate by various columns, outputting the result to STDOUT
######################################################################
...
ggplot_obj <- ggplot_obj + geom_violin (aes (fill=Protein))
